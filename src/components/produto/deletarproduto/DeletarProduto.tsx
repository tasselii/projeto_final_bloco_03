    ...
    return (
        <div className='container w-1/3 mx-auto'>
            ...
            <div className='flex flex-col justify-between overflow-hidden border rounded-2xl'>
                <header
                    className='px-6 py-2 text-2xl font-bold text-white bg-gray-900'>
                    Produto
                </header>
                ...
                <div className="flex">
                    ...
                    <button
                        className='flex items-center justify-center w-full bg-emerald-500 text-slate-100 hover:bg-teal-800'
